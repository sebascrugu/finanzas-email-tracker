...
CREATE TABLE IF NOT EXISTS alert_configs (
    ...
    enable_spending_forecast_alerts BOOLEAN NOT NULL DEFAULT 1,
    enable_budget_forecast_alerts BOOLEAN NOT NULL DEFAULT 1,
    enable_category_trend_alerts BOOLEAN NOT NULL DEFAULT 1,
    ...
    forecast_alert_frequency INTEGER NOT NULL DEFAULT 7,
