...
def reset_database() -> None:
    ...
    """
    logger.warning("=" * 80)
    logger.warning("  ADVERTENCIA: ESTO BORRARÁ TODOS LOS DATOS DE LA BASE DE DATOS")
    logger.warning("=" * 80)
    logger.info("")
    ...
    try:
        ...
        logger.info("  •  Sistema de PERFILES multi-usuario (Profile)")
        logger.info("  •  Separación personal/negocio/familia")
        logger.info("  •  Cada perfil con sus tarjetas y presupuesto")
        logger.info("  •  Búsqueda de correos específica por perfil")
