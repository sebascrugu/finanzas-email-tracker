...
from finanzas_tracker.models.enums import CardType, TransactionStatus, TransactionType
...
class TestProcesarPagoTarjeta:
    ...
    def test_procesa_pago_y_actualiza_saldo(
        self, detector, mock_db, sample_transaction, sample_card
    ):
