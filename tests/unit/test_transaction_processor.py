...
class TestIdentifyBank:
    ...
    def test_identify_bac_from_notificacion(self, processor):
        ...
        email = {
            "from": {
                "emailAddress": {
                    "address": "notificacion@notificacionesbaccr.com"
                }
            }
        }
    ...
    def test_identify_bac_from_bacnet(self, processor):
        ...
        email = {
            "from": {
                "emailAddress": {
                    "address": "notificaciones@bacnet.net"
                }
            }
        }
    ...
    def test_identify_popular_from_infopersonal(self, processor):
        ...
        email = {
            "from": {
                "emailAddress": {
                    "address": "infopersonal@bancopopular.fi.cr"
                }
            }
        }
    ...
    def test_identify_popular_from_cajero(self, processor):
        ...
        email = {
            "from": {
                "emailAddress": {
                    "address": "cajero@bancopopular.fi.cr"
                }
            }
        }
...
class TestApplyCurrencyConversion:
    ...
    def test_convert_usd_to_crc(self, processor):
        ...
        with patch('finanzas_tracker.services.transaction_processor.exchange_rate_service') as mock_service:
...
class TestProcessEmails:
    ...
    def test_process_usd_conversion(self, processor):
        ...
        with patch.object(processor.bac_parser, 'parse', return_value=mock_parsed_data):
            with patch('finanzas_tracker.services.transaction_processor.exchange_rate_service') as mock_rate:
    ...
    def test_process_multiple_emails(self, processor):
        ...
        emails = [
            {"from": {"emailAddress": {"address": "notificacion@notificacionesbaccr.com"}}, "subject": "1"},
            {"from": {"emailAddress": {"address": "infopersonal@bancopopular.fi.cr"}}, "subject": "2"},
...
class TestCategorizeTransaction:
    ...
    def test_categorize_success(self):
        ...
        with patch('finanzas_tracker.services.transaction_processor.TransactionCategorizer') as MockCat:
